...
-- Refatoracao total do avatar: caminho fixo no Storage, URL limpa no banco e cache bust por updated_at.
...
begin
  ...
  if p_foto_path is null or split_part(p_foto_path, '/', 1) <> current_user_id::text then
